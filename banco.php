...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3-twothird">
        <h5>Banco de tiempo</h5>
        <div class="w3-quarter">
          <div class="w3-container w3-blue w3-padding-16">
            <div class="w3-left"><i class="icon-clock-o w3-xxxlarge"></i></div>
            <div class="w3-right">
              <h3></h3>
            </div>
  ...
  <hr>
  <div class="w3-container">
    <h5>Estadisticas de Materias que has dictado</h5>
    <p>Matematicas Avanzada</p>
    <div class="w3-grey">
      <div class="w3-container w3-center w3-padding w3-green" style="width:82%">82%</div>
    </div>

    <p>Español Basico</p>
    <div class="w3-grey">
      <div class="w3-container w3-center w3-padding w3-orange" style="width:59%">59%</div>
    </div>

    <p>Estadistica Intermedia</p>
    <div class="w3-grey">
  ...
  <div class="w3-container">
    ...
    <h6>En esta seccion encontraras las calific </h6>
